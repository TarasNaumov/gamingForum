            ...
            <nav>
                ...
                @if(auth()->user()->status != "read_only")
                    ...
                    <form action="{{ route('admin/category/create') }}" method="GET">
                        ...
                        <button type="submit"
                                class="bg-green-600 hover:bg-green-700 p-3 transition rounded-md font-semibold text-gray-800 dark:text-gray-200 leading-tight w-full">{{ __('CREATE CATEGORY') }}</button>
                    </form>
                @endif
            </nav>
        </div>
