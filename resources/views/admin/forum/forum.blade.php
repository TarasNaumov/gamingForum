            ...
            <nav>
                <form action="{{ route('admin/forum/search') }}" class="mb-6">
                    ...
                    <div class="mb-4">
                        ...
                        <p><input type="radio" name="sort" value="sort_category" class="mr-2" id="subcategory" {{ ($sort == 'sort_subcategory')? "checked" : "" }}><label for="subcategory">Sort by subcategory</label></p>
