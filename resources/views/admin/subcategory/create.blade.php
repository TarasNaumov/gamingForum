<x-app-layout>
    ...
    <x-slot name="slot">
        <form action="{{ route('admin/subcategory/store') }}" method="post" class="rounded-md p-5 mx-auto w-1/5 mt-6 bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500">
            @csrf
            <p class="mb-4">
