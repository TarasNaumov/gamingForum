<x-app-layout>
    ...
    <x-slot name="slot">
        <form action="{{ route('admin/topic/update', $topic) }}" method="post" class="rounded-md p-5 mx-auto w-1/5 mt-6 bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500">
            @csrf
            @method('patch')
            <p class="mb-4">
