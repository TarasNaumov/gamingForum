...
Route::post('/admin/subcategory/create', [AdminSubcategoryController::class, 'create'])->name('admin/subcategory/create');
...
Route::post('/admin/forum/create', [AdminForumController::class, 'create'])->name('admin/forum/create');
